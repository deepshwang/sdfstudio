...
class KITTI360Camera:
    def __init__(self):
        ...
        for frame, pose in zip(frames, poses):
            pose = np.concatenate((pose, np.array([0.0, 0.0, 0.0, 1.0]).reshape(1, 4)))
...
class KITTI360CameraPerspective(KITTI360Camera):
    def __init__(self, root_dir, seq="2013_05_28_drive_0009_sync", cam_id=0):
        ...
        self.cam_id = cam_id
        super(KITTI360CameraPerspective, self).__init__()
